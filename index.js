...
app.post('/api/webhook', async (req, res) => {
  try {
    ...
    // Detect and process Tatum payload (TRON)
    else if (body.subscriptionType === 'ADDRESS_EVENT' && body.chain && body.chain.toLowerCase().startsWith('tron')) {
      ...
      const explorerUrl = chain.toLowerCase().includes('testnet') ? 'https://nile.tronscan.org/#/transaction/' : 'https://tronscan.org/#/transaction/';
